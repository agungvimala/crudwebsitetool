  ...
  <head>
    ...
    <form class="mb-3">
        <div class="input-group">
            <input type="text" id="search-input" class="form-control" placeholder="Cari berdasarkan keyword..."
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="kelola.php?ubah=<?php echo $result['id_tamu']; ?>" type="button" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                            <a href="proses.php?hapus=<?php echo $result['id_tamu']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"><i class="fa-solid fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                <?php
                    }
