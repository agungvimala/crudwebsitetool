    ...
    <div class="container mt-3">
        <form method="POST" action="proses.php">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                <textarea required class="form-control" id="alamat" name="alamat" rows="3" placeholder="Ex: Jalan Gunung Agung"><?php echo $alamat; ?></textarea>
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                <textarea required class="form-control" id="pesan" name="pesan" rows="3" placeholder="Ex: Selamat menempuh hidup baru"><?php echo $pesan; ?></textarea>
                </div>
            </div>
